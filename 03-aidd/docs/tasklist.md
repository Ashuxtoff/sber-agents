...
| 2 - Интеграция с LLM | ✅ Готово | Подключение OpenRouter и вызов модели |
| 3 - Ассистент с ролью | ✅ Готово | Добавление системного промпта |
| 4 - Обработка ошибок | ✅ Готово | Корректная обработка ошибок API |
| 5 - Документация | ✅ Готово | README с инструкциями запуска |
...
- [x] Инициализировать OpenAI client с OpenRouter base_url
- [x] Создать функцию вызова LLM
- [x] Заменить эхо на вызов LLM
- [x] Добавить логирование вызовов LLM
- [x] Протестировать: бот отвечает через модель (без системного промпта)
...
- [x] Определить системный промпт с ролью ассистента
- [x] Добавить системный промпт в вызов LLM
- [x] Протестировать: бот отвечает согласно роли
- [x] Проверить: разные вопросы → разные ответы
...
- [x] Добавить try-except для вызова LLM
- [x] Добавить обработку ошибок Telegram API
- [x] Добавить пользовательское сообщение об ошибке
- [x] Добавить логирование ошибок через `print()`
- [x] Протестировать: отключить интернет → бот пишет об ошибке
...
- [x] Добавить инструкцию установки зависимостей
- [x] Добавить инструкцию настройки .env
- [x] Добавить инструкцию запуска бота
- [x] Добавить пример использования
- [x] Протестировать: новый разработчик запускает по README
